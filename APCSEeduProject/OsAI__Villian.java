...
{
    //learning values
    double clsx = -0.49765399372355124;//close to x?
    double clso = 0.04978554671984303;//close to o?
    double fin3 = -0.14123380769745092;
    double crnr = 0.10434359410564548;//corner
    double sids = 0.13918084473833717;//sides
    double midl = -0.05275109853878332;//middle
    double stick = 0.7;
    double carrot = 1.0;
    /**Make an o move
