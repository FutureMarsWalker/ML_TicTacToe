...
{
    //learning values
    double clsx;//close to x?
    double clso;//close to o?
    double fin3;//try to get 3 in a row
    double crnr;//corner
    double sids;//sides
    double midl;//middle
    double stick;
    ...
    public OsAI__Villian(boolean isObserver)
    {
        //learning variables
    // clsx = -0.49765399372355124;//close to x?
    // clso = 0.04978554671984303;//close to o?
    // fin3 = -0.14123380769745092;
    // crnr = 0.10434359410564548;//corner
    // sids = 0.13918084473833717;//sides
    // midl = -0.05275109853878332;//middle
    // stick = 0.7;
    // carrot = 1.0;
    ...
    public int oAIgo(String bd) 
    {
        ...
        // for(int l = 8; l >= 0; l--)//repeats 9 times
        // {
    ...
    public void OStick(int result)
    {
        ...
        // {
            ...
            // clsx -= (rand * stick); //This basically subtracts (random number * 0.7) from clsx
        // }
        // if (clso >= a)
        // {
            // double rand = Math.random();
    ...
    public void OCarrot(int result)
    {
        brute.learn(result);
        // double t = clsx + clso + fin3 + crnr + sids + midl;
        // double a = t / 6.0;
